...
class CategoryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $validasi['slug'] = str()->slug($validasi['category']);
    ...
    public function update(Request $request, Category $category)
    {
        ...
        if ($request->category != $category->category) {
            $rules['category'] = 'required|unique:categories';
        }
        $validasi = $request->validate($rules);

        $category->update($validasi);

        return redirect('/dashboard/categories')->with('success','Kategori Berhasil Di Edit');
    }
